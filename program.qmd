...
-   Köhler, J., Jansen, M., Rodríguez, A., Kok, P. J. R., Toledo, L. F., Emmrich, M., ... & Vences, M. (2017). [The use of bioacoustics in anuran taxonomy: theory, terminology, methods and recommendations for best practice](https://www.mvences.de/p/p1/Vences_A354.pdf). Zootaxa, 4251(1), 1-124. (*at least the first 28 pages*)
...
1.  Use the any of the query functions (e.g. `query_gbif()`, `query_macaulay()`, `query_xenocanto()`) from the [suwo package](https://github.com/ropensci/suwo) to check the availability of recordings for a species of interest. This repositories offers recordings for several taxonomic groups. Take a look at the [suwo vignette](https://docs.ropensci.org/suwo/articles/suwo.html) for a list of taxonomic groups by repository. Check [this brief tutorial](get_online_recordings.qmd) on how to get the recordings with suwo.
...
1.  Use Raven Pro to annotate some of the signals found in the recordings you downloaded previously
:::
