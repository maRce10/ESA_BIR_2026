...
https://ravensoundsoftware.com/video-tutorials/
...
rvn.dat <- imp_raven(all.data = FALSE, freq.cols = TRUE, path = "./examples", warbler.format = TRUE)
...
URL <- "https://github.com/maRce10/ESA_BIR_2026/raw/master/data/extended.selection.table.araya-salas.et.al.2017.bioacoustics.100.sels.rds"
