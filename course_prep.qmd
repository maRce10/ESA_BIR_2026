...
4)  Make a directory called "BIR2026", this will be your working directory for the course.
...
7)  Also in Rstudio: Go back up to the "File" tab and select "New Project", then select the "BIR2026" directory.
