...
4)  Make a directory called "BIACOUSTICS_R_2026" (or any name you want), this will be your working directory for the course.
...
7)  Also in Rstudio: Go back up to the "File" tab and select "New Project", then select the "BIACOUSTICS_R_2025" directory.

8) Download [this folder](https://www.dropbox.com/scl/fo/mooazn5xd6zxmyy9y1skd/AGuTnwjq2Lr6668s4XbKSWA?rlkey=unqwf7war0458be63n7ltyzaf&st=80d90tn8&dl=0) within the Rstudio project directory. Make sure is saved as a subfolder called "examples"

9)  Now in the R console in Rstudio: Run the following code to install packages. This includes the latest developmental versions (from github) of warbleR, Rraven and ohun (remove the packages first if you have them installed already).
...
1) The following R packages will be used in a couple of instances during the course (development versions from github): 
...
2) Install ffmpeg (only needed for dynaSpec package):
...
3) Install Audacity (you can use Adobe Audition instead):

<https://www.audacityteam.org/download/>

4) Install SOX. It can be downloaded from here: 

[http://sox.sourceforge.net](http://sox.sourceforge.net/)

5) Install FLAC. It can be downloaded from here: 

[https://xiph.org/flac/download.html](http://sox.sourceforge.net/)


Note that you can also run the code using google colab. Take a look at this notebook:

[https://colab.research.google.com/](https://colab.research.google.com/drive/13Hb4sdvg6FgQi0pF1Z-Y2UrirVPpNJjb?usp=sharing)
